...
setup(
    ...
    # dependencies
    install_requires=[
        "numpy>=1.26.4,<2.0", # "numpy>=1.21.6",  # "numpy>=1.19.3",
        "matplotlib>=3.9.4,<4.0",
        "scipy>=1.13.1,<2.0",  # "scipy>=1.4.1",
        "astropy>=6.0.1,<7.0",  # "astropy>=5.1",  # "astropy>=4.2.1",
        "astroquery==0.4.6",  # "astroquery>=0.4.7",  # "astroquery>=0.4.1",
        "pandas>=2.3.1,<3.0",  # "pandas>=1.4.2",  # "pandas>=1.1.4",
        ...
        "ordered_set>=4.1.0,<5.0",
        "statsmodels>=0.12.2",
        "diptest>=0.10.0,<0.11.0",  # "unidip>=0.1.1",
        "typing_extensions>=4.14.1,<5.0",
        "tqdm>=4.67.1",
    ],
    extras_require={
        # dev dependencies
